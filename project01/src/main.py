...
# APP_TOKEN = "gigKo8HICQOmfCouTD2zKnIRz"
# INDEX_NAME = "project3"
# ES_HOST = "https://search-sta9760akhila-o434s7rmvxgaapudhmyi6v7cju.us-east-2.es.amazonaws.com" 
# ES_USERNAME = "akhilap"
# ES_PASSWORD = 'Bigdata@1'
...
parser.add_argument("--num_pages",type=int, help="Number of pages to fetch", required=False)
parser.add_argument("--offset",type=int, help="Where to start", required=False, default=0)
...
if __name__ == '__main__':
    ...
    try:
        resp = requests.post(
            f"{ES_HOST}/_bulk",
            auth=HTTPBasicAuth(ES_USERNAME, ES_PASSWORD),
            data=bulk_upload_data.encode('utf-8'),
            headers={
